 ...
 * @author Lohran
 */
public class TelaTres extends javax.swing.JDialog {

    ControleAlunos ca;
    /**
     * Creates new form TelaTres
     */
    public TelaTres(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    
    public TelaTres(java.awt.Frame parent, boolean modal, ControleAlunos ca) {
        super(parent, modal);
        this.ca = ca;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(18, 278, -1, -1));
        getContentPane().add(tdfNome, new org.netbeans.lib.awtextra.AbsoluteConstraints(18, 156, 210, -1));
        getContentPane().add(tdfMat, new org.netbeans.lib.awtextra.AbsoluteConstraints(18, 236, 210, -1));
        ...
        getContentPane().add(tdfIdade, new org.netbeans.lib.awtextra.AbsoluteConstraints(346, 156, 210, -1));
        ...
        getContentPane().add(btnVoltar, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 380, -1, -1));
        ...
        getContentPane().add(tdfData, new org.netbeans.lib.awtextra.AbsoluteConstraints(346, 304, 210, -1));

        jLabel1.setFont(new java.awt.Font("Segoe UI Black", 3, 32)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("Inserir Terceiro Aluno");
        ...
        getContentPane().add(tdfCPF, new org.netbeans.lib.awtextra.AbsoluteConstraints(346, 236, 210, -1));
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(18, 210, -1, -1));
        ...
        getContentPane().add(tdfTel, new org.netbeans.lib.awtextra.AbsoluteConstraints(18, 304, 210, -1));

        btnInserir.setFont(new java.awt.Font("Segoe UI Black", 3, 14)); // NOI18N
    ...
    private void btnInserirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInserirActionPerformed
        ...
        try {
            a.setData(tdfData.getText());
        } catch (ParseException ex) {
            Logger.getLogger(TelaTres.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaTres.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaTres dialog = new TelaTres(new javax.swing.JFrame(), true);
